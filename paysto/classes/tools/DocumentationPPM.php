...
class DocumentationPPM
{
    public static function assignDocumentation()
    {
        ...
        ToolsModulePPM::addCSS('documentation.css');
        $documentation_folder = _PS_MODULE_DIR_.ToolsModulePPM::getModNameForPath(__FILE__)
            .'/views/templates/admin/documentation';
        $documentation_pages = ToolsModulePPM::globRecursive($documentation_folder.'/**.tpl');
